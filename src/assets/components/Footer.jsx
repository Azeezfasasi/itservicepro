      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:justify-between gap-8">
        ...
        <div className="flex-1 mb-6 md:mb-0">
          ...
          <div className="flex items-center mb-2">
            ...
            <a href="tel:08103069432" className="text-gray-200 hover:text-[#00B9F1] transition">(+234) 08103069432</a>
          </div>
          <div className="flex items-center mb-2">
            <Mail className="w-4 h-4 mr-2 text-[#00B9F1]" />
            <a href="mailto:info@mgv-tech.com" className="text-gray-200 hover:text-[#00B9F1] transition">info@mgv-tech.com</a>
          </div>
