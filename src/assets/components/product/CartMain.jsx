...
const CartMain = () => {
  ...
  const handleQuantityInputChange = (productId, event) => {
    ...
    // If input is empty or invalid, you might want to debounce or prevent immediate API call
  };
                    ...
                    <tr key={item.productId} className="hover:bg-gray-50 transition duration-150 ease-in-out">
                      <td className="px-6 py-4 whitespace-nowrapx">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <Link to={`/app/productdetails/slug/${item.slugId}`} className="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline">
                               {item.name}
                            </Link>
                          </div>
                        </div>
            ...
            {cart.items.length > 0 && (
              <div className="flex justify-end mt-6">
                <button
                  ...
                  className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded-md transition duration-300 ease-in-out flex items-center gap-2"
                >
                  <FaTrash /> Clear Cart
                </button>
              </div>
