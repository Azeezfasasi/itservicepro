          ...
          <div className="flex flex-col justify-center text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-8 mt-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Fast Service: <a href="tel:08103069432" className="text-blue-500 hover:underline">(+234) 08103069432</a></span>
              </div>
              <div className="flex items-center space-x-3">
                {/* Mail icon */}
                ...
                <span className="text-gray-700"><a href="mailto:info@mgv-tech.com" className="text-blue-500 hover:underline">info@mgv-tech.com</a></span>
              </div>
            </div>
          </div>
